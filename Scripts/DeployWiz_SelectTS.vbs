...
' Custom : Show the %Make% and %Model% variables 
Function InitializeCustomShowMakeModel

	CustomShowMake.innerhtml = oEnvironment.Item("Make")
	CustomShowModel.innerhtml = oEnvironment.Item("Model")
